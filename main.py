...
def web_scraper(input):
    ...
    for i in range(0,len(keys)):
        ...
        previous_len = 0
        try:
            for lines in open("Articles.bank", 'r',encoding='utf-8'):
                previous_len += 1
...
#"tax reform, health reform, machine learning, google i/o, health care, artificial intelligence, nature language processing, samsung, trump reform, obama reform, china us relation, computer architecture, nanotechnology, biological medician, china south sea, trade war, machine translation, neural science, deep learning, apple, banana, yorktown"